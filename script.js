...
var APPS = {
    ...
    'web': {title: 'Cine-Web', path: 'script/Apps/Web/index.html', icon: 'https://img.icons8.com/color/512/brave-web-browser.png', pinned: true},
    ...
    'Maxchat': {title: 'Snapkeys', path: 'script/Apps/Maxchat/index.html', icon: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0VTIWimnwKT6kMHMAG20E_IUdFDAx8CexaUaB9twOlA&s=10', pinned: false},
};
